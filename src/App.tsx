    ...
    <main id="conteudo">
      <section id="inicio" className="hero section-shell" aria-labelledby="hero-title">
        ...
        <div className="hero-visual">
          ...
          <div className="hero-bike-parallax"><img className="hero-bike" src={imagePath('ebike-cutout.webp')} width="1440" height="960" fetchPriority="high" alt="Conceito de e-bike urbana verde floresta com pneus de faixa bege e bagageiro." /></div>
      ...
      <section className="life-photo" aria-labelledby="life-title"><img src={imagePath('morning-ride.webp')} alt="Cena ilustrativa de duas pessoas com capacete pedalando e-bikes em uma rua arborizada pela manhã." width="1600" height="1067" loading="lazy" /><div className="life-overlay" /><div className="life-content section-shell"><span className="eyebrow light"><span /> A MELHOR PARTE É O CAMINHO</span><h2 id="life-title">O destino é o mesmo.<br /><em>A sua vida, em outro ritmo.</em></h2><span className="life-caption"><Bike size={18} /> MAIS MOVIMENTO CABE NO SEU DIA.</span></div><span className="life-credit">Cenário ilustrativo do projeto</span></section>
      ...
      <section className="campaign-section section-shell" aria-labelledby="campaign-title">
        ...
        <div className="bus-scene" data-reveal><div className="bus-stop-sign"><BusFront size={22} /><span>UM NOVO<br />PONTO DE VISTA</span></div><div className="scene-orbit" aria-hidden="true" /><div className="poster-frame"><div className={`campaign-poster poster-${campaign}`} key={campaign}><Logo /><span className="poster-eyebrow">{campaigns[campaign].tag}</span><h3>{campaigns[campaign].heading}</h3><div className="poster-bike"><img src={imagePath('ebike-cutout.webp')} alt="" width="1440" height="960" loading="lazy" /></div><p>{campaigns[campaign].detail}</p><span className="poster-bottom">VEM DE PEDALFREE <ArrowUpRight size={20} /></span></div></div><span className="scene-caption">CONCEITO DE CAMPANHA · MÍDIA URBANA</span></div>
      </section>
